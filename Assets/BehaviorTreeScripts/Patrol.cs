...
public class Patrol : Action
{
    ...
    public override TaskStatus OnUpdate()
    {
        ...
        transform.forward = Vector3.Lerp(transform.forward,point.position-transform.position,0.5f).normalized;//改变方向
        transform.position = Vector3.MoveTowards(transform.position,point.position,speed.Value*Time.deltaTime);//移动
